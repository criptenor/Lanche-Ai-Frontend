...
class AdicionarProdutoWidget extends StatefulWidget {
  const AdicionarProdutoWidget({super.key});
                          ...
                          children: [
                            ...
                            FutureBuilder<List<CategoriaRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CategoriaRow> dropDownCategoriaRowList =
                                    snapshot.data!;
                                return FlutterFlowDropDown<String>(
                                  controller: _model.dropDownValueController ??=
                                      FormFieldController<String>(null),
                                  options: dropDownCategoriaRowList
                                      .map((e) => e.nome)
                                      .withoutNulls
                                      .toList(),
                                  onChanged: (val) async {
            ...
            child: FFButtonWidget(
              onPressed: () async {
                ...
                await ProdutosTable().insert({
                  ...
                  'id_categoria': _model.idCategoria,
                  'nome': _model.textController1.text,
                  'valor': double.tryParse(_model.textController4.text),
                  'descricao': (_model.textFieldFocusNode2?.hasFocus ?? false)
                      .toString(),
                  'path_foto': valueOrDefault<String>(
                    _model.uploadedFileUrl2,
                    '0',
                  ),
                });

                context.pushNamed('ProdutoAdiconado');
              },
              text: 'Adiconar Produto',
