  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<LojaRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LojaRow> cadastroLojaRowList = snapshot.data!;
        final cadastroLojaRow =
            cadastroLojaRowList.isNotEmpty ? cadastroLojaRowList.first : null;
