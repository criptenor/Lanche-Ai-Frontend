  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ComplementoNoProdutoCompradoRow:
            return ComplementoNoProdutoCompradoRow(data);
          case LojaRow:
            return LojaRow(data);
          case PedidoRow:
            return PedidoRow(data);
          case ComplementoRow:
            return ComplementoRow(data);
          case ProdutosRow:
            return ProdutosRow(data);
          case ProdutosCompradosRow:
            return ProdutosCompradosRow(data);
          case CategoriaRow:
            return CategoriaRow(data);
          case CompraRow:
            return CompraRow(data);
          default:
            return null;
        }
