      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'buscarProduto')
              : BuscarProdutoWidget(),
        ),
        FFRoute(
          name: 'Inicio',
        ...
        FFRoute(
          ...
          builder: (context, params) => AdicionarProdutoWidget(),
        ),
        FFRoute(
          name: 'ProdutoAdiconado',
          path: '/produtoAdiconado',
          builder: (context, params) => ProdutoAdiconadoWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/detalhesHistorico',
          builder: (context, params) => DetalhesHistoricoWidget(
            id: params.getParam(
              'id',
              ParamType.int,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => FinalizarPedidoWidget(),
        ),
        FFRoute(
          name: 'gerirPedidos',
          path: '/gerirPedidos',
          builder: (context, params) => GerirPedidosWidget(),
        ),
        FFRoute(
          name: 'configuracoesAdm',
          path: '/configuracoesAdm',
          builder: (context, params) => ConfiguracoesAdmWidget(),
        ),
        FFRoute(
          name: 'WelcomePage',
          path: '/welcomePage',
